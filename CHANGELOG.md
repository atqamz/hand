...
## [0.8.0](https://github.com/atqamz/hand/compare/v0.7.2...v0.8.0) (2026-09-25)


### Features

* **attempt:** record canonical Attempts from the current Worker route ([#668](https://github.com/atqamz/hand/issues/668)) ([276269d](https://github.com/atqamz/hand/commit/276269d833ddaa3238262fb57638f0fced9f92ed))
* **attention:** derive bounded current input attention ([#617](https://github.com/atqamz/hand/issues/617)) ([ce4fd14](https://github.com/atqamz/hand/commit/ce4fd142fc39477d957ee2cd22c7c69ef21d591b))
* **config:** read typed worker policy candidate ([#622](https://github.com/atqamz/hand/issues/622)) ([750f742](https://github.com/atqamz/hand/commit/750f74212545fcd290e463e822b78013fdc7861e))
* **cutover:** run the offline v19 cutover and gate recover on witness and drift ([#677](https://github.com/atqamz/hand/issues/677)) ([94d2dbd](https://github.com/atqamz/hand/commit/94d2dbd6b37617cb02a69e2b9a70802b78337496))
* **decision:** record exact Answer-origin WorkerInput ([#612](https://github.com/atqamz/hand/issues/612)) ([771482e](https://github.com/atqamz/hand/commit/771482e866ddc64422cedc2aed7bbc46ec1d6fac))
* **execguard:** guard a Launch handoff's harness tree on Linux ([#662](https://github.com/atqamz/hand/issues/662)) ([8637eb3](https://github.com/atqamz/hand/commit/8637eb389999055446db113d60f9dec20a2a69e8))
* **fleet:** add current AttemptBackoff and Repair snapshot rows ([#688](https://github.com/atqamz/hand/issues/688)) ([ff1927d](https://github.com/atqamz/hand/commit/ff1927d27648d6fb2ce6b9e12985c60fd04028cc))
* **fleet:** add current open Decision snapshot rows ([#689](https://github.com/atqamz/hand/issues/689)) ([37666ee](https://github.com/atqamz/hand/commit/37666ee9be3be1168f2d7d87500f75d5577d7bd7))
* **fleet:** project current executor bindings ([#618](https://github.com/atqamz/hand/issues/618)) ([08ed50b](https://github.com/atqamz/hand/commit/08ed50b334ed43aa994f79c6c2016d2ce04d1795))
* **fleet:** project current TaskHolds in partial FleetSnapshot ([#657](https://github.com/atqamz/hand/issues/657)) ([f9cb33a](https://github.com/atqamz/hand/commit/f9cb33ab18297023c7e9f6cdfc12a612020608fa))
* **fleet:** project latest worker report metadata ([#630](https://github.com/atqamz/hand/issues/630)) ([f4dcb2f](https://github.com/atqamz/hand/commit/f4dcb2f75d3cc51ad3c93a173083c2114c36601a))
* **fleet:** project open worktree and session bindings ([#624](https://github.com/atqamz/hand/issues/624)) ([19200c0](https://github.com/atqamz/hand/commit/19200c084e1ca36f44dc8cfc7847fd084bd75026))
* **herdr:** type only the exec-guard invocation into a Launch pane ([#680](https://github.com/atqamz/hand/issues/680)) ([6db5f5f](https://github.com/atqamz/hand/commit/6db5f5fef89f6ee85f0745c53f1c4ee0f55928b3))
* integrate canonical v19 CLI and exact authority ([#601](https://github.com/atqamz/hand/issues/601)) ([8a69531](https://github.com/atqamz/hand/commit/8a6953120fd84cd00308fc1c0c3c57d3aa75ac43))
* **osfacts:** read Hand-side OS facts for the exec-guard contract ([#670](https://github.com/atqamz/hand/issues/670)) ([c4b56b5](https://github.com/atqamz/hand/commit/c4b56b5cee061b97a257d6e4ca14abb123f636df))
* **routing:** preview exact Worker Route candidates ([#631](https://github.com/atqamz/hand/issues/631)) ([c425cc6](https://github.com/atqamz/hand/commit/c425cc6daa85b3b0c97d478c2e6d12406edb1e49))
* **runtime:** add the post-witness cutover drift gate ([#676](https://github.com/atqamz/hand/issues/676)) ([e834353](https://github.com/atqamz/hand/commit/e8343539dfeb1f98bb57f1cf0dee5caa3524435f))
* **runtime:** expose canonical WorkerInput protocol ([#578](https://github.com/atqamz/hand/issues/578)) ([0b5657b](https://github.com/atqamz/hand/commit/0b5657b00be95ed8d9cfdcb03ee1ff54a5ffb34c))
...
* **store:** abandon exact canonical Tasks through their active Plan and Attempt ([#666](https://github.com/atqamz/hand/issues/666)) ([f216f33](https://github.com/atqamz/hand/commit/f216f336055f7c469ed4ee1a8d7989ff04480c4a))
* **store:** abort an unpublished offline cutover back to the legacy DB ([#675](https://github.com/atqamz/hand/issues/675)) ([4e97497](https://github.com/atqamz/hand/commit/4e97497c506e32e192ad17b73f1d948c163ef7aa))
* **store:** acknowledge canonical WorkerInput ([#575](https://github.com/atqamz/hand/issues/575)) ([b9f81dd](https://github.com/atqamz/hand/commit/b9f81dd699263fd2a4a36a1705cdcfe9f33dc825))
...
* **store:** add canonical v19 Interrupt persistence ([#567](https://github.com/atqamz/hand/issues/567)) ([b2c220f](https://github.com/atqamz/hand/commit/b2c220f0e6c5185f2117c0382ace07c1aa66c6a0))
* **store:** add canonical v19 Launch persistence ([#566](https://github.com/atqamz/hand/issues/566)) ([73f7b52](https://github.com/atqamz/hand/commit/73f7b5284ae1acd1675ebe73e9cd357d38dfb46d))
...
* **store:** add canonical v19 SessionBinding lifecycle ([#565](https://github.com/atqamz/hand/issues/565)) ([6e2d682](https://github.com/atqamz/hand/commit/6e2d682f9b3a083692ba8896b8d31424d4dd19d6))
...
* **store:** add canonical v19 WorktreeCreate persistence protocol ([#561](https://github.com/atqamz/hand/issues/561)) ([b97477c](https://github.com/atqamz/hand/commit/b97477c28dfa2486fd76182cb2a6ec16235a17d2))
* **store:** add native Git WorktreeCreate reconciliation ([#562](https://github.com/atqamz/hand/issues/562)) ([0a59733](https://github.com/atqamz/hand/commit/0a59733bbc96fd8869a40efaf955b8fc2f7b879e))
* **store:** add offline cutover preflight facts and boot witness ([#671](https://github.com/atqamz/hand/issues/671)) ([0aa00d3](https://github.com/atqamz/hand/commit/0aa00d320e41278b7f97908ca49723ba1a699b9d))
...
* **store:** bind Answer-origin WorkerInput ([#574](https://github.com/atqamz/hand/issues/574)) ([4fcb6ce](https://github.com/atqamz/hand/commit/4fcb6ce75c49a663c0b81671b09f2251f19fcf1c))
* **store:** bind boot evidence and manifest digest in freeze certificate v2 ([#672](https://github.com/atqamz/hand/issues/672)) ([7a1ec5f](https://github.com/atqamz/hand/commit/7a1ec5f1b27a9c59417553cd6e6e2f6a28bcbf37))
...
* **store:** classify a guarded Launch from its exec-guard records ([#682](https://github.com/atqamz/hand/issues/682)) ([c2298b6](https://github.com/atqamz/hand/commit/c2298b63b7ba484bfc281c82c89e133707d7a44c))
...
* **store:** close a guarded ExecutorBinding from its guard's cessation ([#699](https://github.com/atqamz/hand/issues/699)) ([2d4594d](https://github.com/atqamz/hand/commit/2d4594d7889ad2254135ab85b7e71a9500a97081))
* **store:** commit the exec-guard credential and key grammar on Linux ([#681](https://github.com/atqamz/hand/issues/681)) ([228a7bb](https://github.com/atqamz/hand/commit/228a7bb8230d7926eaa52faaac304343a07a06b5))
* **store:** drain canonical WorkerInput ([#577](https://github.com/atqamz/hand/issues/577)) ([5eeace5](https://github.com/atqamz/hand/commit/5eeace5cc0656fcc6e3362c45d8d4253bee80243))
...
* **store:** ingest canonical WorkerReport ([#581](https://github.com/atqamz/hand/issues/581)) ([7003675](https://github.com/atqamz/hand/commit/700367514ff4e15fd7399de6aaff7e2fbcb06ff3)), closes [#579](https://github.com/atqamz/hand/issues/579) [#339](https://github.com/atqamz/hand/issues/339)
* **store:** interrupt a guarded ExecutorBinding through its guard's request record ([#702](https://github.com/atqamz/hand/issues/702)) ([c58858d](https://github.com/atqamz/hand/commit/c58858dfc5a559094228aae19e0c83ef328e4161))
* **store:** land the exec-guard Launch adapter dormant behind the rev-1 refusal ([#683](https://github.com/atqamz/hand/issues/683)) ([e5e2f01](https://github.com/atqamz/hand/commit/e5e2f011030d619a51f68529dd287277bff62c79))
...
* **store:** persist canonical v19 WorktreeRemove lifecycle ([#563](https://github.com/atqamz/hand/issues/563)) ([230100c](https://github.com/atqamz/hand/commit/230100c3d3bebfd6007c1e17024a4cc2a53a6d1f))
* **store:** persist canonical WorkerWake ([#576](https://github.com/atqamz/hand/issues/576)) ([40b94bc](https://github.com/atqamz/hand/commit/40b94bcbf77b00cb58a4e309b4426824748ab6e1))
...
* **store:** persist exact Decision and Answer authority ([#598](https://github.com/atqamz/hand/issues/598)) ([fa825a2](https://github.com/atqamz/hand/commit/fa825a2e999780138f1b85612456bb3f9ff08d5e))
...
* **store:** reconcile Herdr Interrupt ([93d8236](https://github.com/atqamz/hand/commit/93d8236b91ae7060edfc8fcabac6d7b2378cab21))
* **store:** reconcile Herdr Launch ([#570](https://github.com/atqamz/hand/issues/570)) ([1f82e0a](https://github.com/atqamz/hand/commit/1f82e0a8372bc51709377abe2f55dfee91ec1ea4))
* **store:** reconcile Herdr SessionAcquire ([#568](https://github.com/atqamz/hand/issues/568)) ([e04de6a](https://github.com/atqamz/hand/commit/e04de6a0219421d8ee1c3dad36beaa0a73278a61))
* **store:** reconcile Herdr SessionRelease ([#569](https://github.com/atqamz/hand/issues/569)) ([8b69de3](https://github.com/atqamz/hand/commit/8b69de3ee4249810fe6d895edd1faae99aec6d96))
* **store:** reconcile Herdr WorkerWake ([#580](https://github.com/atqamz/hand/issues/580)) ([47bc0e1](https://github.com/atqamz/hand/commit/47bc0e1e950dd59d3f816306e625e45da5b5dd4f))
* **store:** reconcile native Git WorktreeRemove ([#564](https://github.com/atqamz/hand/issues/564)) ([8703886](https://github.com/atqamz/hand/commit/870388645ee289b91fe473f9af5380a5bbedf8e1))
* **store:** retain requested Attempt overrides separately ([#613](https://github.com/atqamz/hand/issues/613)) ([552cb4e](https://github.com/atqamz/hand/commit/552cb4e556050361ab78b8c0210691ec834212bb))
...
* **store:** write canonical WorkerInput ([#573](https://github.com/atqamz/hand/issues/573)) ([3c44fe5](https://github.com/atqamz/hand/commit/3c44fe544eec53c1e07167ebf7d9b30c589a7888))
* **task:** allow archiving terminal tasks without effect resources ([#653](https://github.com/atqamz/hand/issues/653)) ([d7e9f1d](https://github.com/atqamz/hand/commit/d7e9f1de7a3668c3d3ed3a948b72b5f090d5f767))
* **task:** archive terminal tasks whose resource lineage is released ([#692](https://github.com/atqamz/hand/issues/692)) ([589f960](https://github.com/atqamz/hand/commit/589f96066b3b5cec5cf09cfe03fc271fdb95ad78))
* **task:** list exact archive membership ([#623](https://github.com/atqamz/hand/issues/623)) ([eae6130](https://github.com/atqamz/hand/commit/eae61305b3a6d03d1a29611fca779f63623bf33a))
* **task:** read exact archive history after terminalization ([#615](https://github.com/atqamz/hand/issues/615)) ([33d9378](https://github.com/atqamz/hand/commit/33d9378572645abfcb516f46039841c88fa5aaae))
* **task:** record bounded canonical archive fact ([#610](https://github.com/atqamz/hand/issues/610)) ([6002820](https://github.com/atqamz/hand/commit/6002820d580bcda9662ed63767d2442dca0b2bec))


### Bug Fixes

* **cutover:** refuse unsafe automatic v0.7.2 freeze ([#611](https://github.com/atqamz/hand/issues/611)) ([b5e4a32](https://github.com/atqamz/hand/commit/b5e4a324543df1762ba23b336b7cda9eec26029a))
* **harness:** keep unverified capabilities unknown ([#614](https://github.com/atqamz/hand/issues/614)) ([c88a185](https://github.com/atqamz/hand/commit/c88a185534a66178d9fd98edababd414a9519b5f))
* **harness:** reject stale generated launch appendices ([#597](https://github.com/atqamz/hand/issues/597)) ([650a7c6](https://github.com/atqamz/hand/commit/650a7c616ac6da55a1d7a6653d4ef8cc34333140)), closes [#579](https://github.com/atqamz/hand/issues/579)
* **herdr:** escape every PowerShell single-quote character ([#694](https://github.com/atqamz/hand/issues/694)) ([a410edf](https://github.com/atqamz/hand/commit/a410edfd6cf4a7330b50991502011a0f19187af9))
* **herdr:** harden exact launch preflight ([#584](https://github.com/atqamz/hand/issues/584)) ([98634ba](https://github.com/atqamz/hand/commit/98634babd3963b2503de48c8730f17298d9c0c92))
* **npm:** fail closed on config inspection ([#591](https://github.com/atqamz/hand/issues/591)) ([65736e8](https://github.com/atqamz/hand/commit/65736e8cbafcaeebcffcf54461627b63543d31f1))
* **project:** preserve effective Git transport and rewrite identity ([#587](https://github.com/atqamz/hand/issues/587)) ([e37693b](https://github.com/atqamz/hand/commit/e37693bdd5633033602385fd9ebda3c7253d83e6)), closes [#520](https://github.com/atqamz/hand/issues/520)
* **project:** report an open no-mistakes run as unknown instead of absent ([#659](https://github.com/atqamz/hand/issues/659)) ([aaa7d66](https://github.com/atqamz/hand/commit/aaa7d66c94bee3d68ccc4210147977a32c64ccde))
* **release:** let qualification outlast main CI and gate GitHub publish on approval ([#658](https://github.com/atqamz/hand/issues/658)) ([6a5d09a](https://github.com/atqamz/hand/commit/6a5d09a7a29b12eaedbdfb8a0a9b67e95cb0b698))
* retain managed child ownership after guardian close ([#602](https://github.com/atqamz/hand/issues/602)) ([2e13391](https://github.com/atqamz/hand/commit/2e13391968cbbab218da87e0325571ccf5925cad))
* **routing:** keep worker policy diagnostics free of config bytes ([#656](https://github.com/atqamz/hand/issues/656)) ([730cc68](https://github.com/atqamz/hand/commit/730cc68a056e3bedd9b7990f1a869ae1c0710e24))
* **runtime:** preserve exact generation and supervisor ownership ([#590](https://github.com/atqamz/hand/issues/590)) ([c15cbd3](https://github.com/atqamz/hand/commit/c15cbd3d444ef47e8f9cd4321314c6310a59e2b8)), closes [#502](https://github.com/atqamz/hand/issues/502) [#518](https://github.com/atqamz/hand/issues/518) [#519](https://github.com/atqamz/hand/issues/519)
* **runtime:** refuse path-only Treehouse returns for legacy attempts ([#691](https://github.com/atqamz/hand/issues/691)) ([a594033](https://github.com/atqamz/hand/commit/a594033659f2e6a479b05a38dd4d65a74db45f2a))
* **store:** activate reviewed v19 replacement guards ([9ca4e20](https://github.com/atqamz/hand/commit/9ca4e206d0884cf3b4630350e027879ce9f7579a))
* **store:** fail closed on unproven Herdr identity ([#585](https://github.com/atqamz/hand/issues/585)) ([b6bbef8](https://github.com/atqamz/hand/commit/b6bbef805d57a57b5a6538ee926f6289cf7eaee0))
* **store:** guard immutable v19 rows against replacement ([3fa9e0a](https://github.com/atqamz/hand/commit/3fa9e0a5c9829412ad5fcbec64f6e0fb174ddaac))
* **store:** make POSIX physical identity survive reboot and remount ([#667](https://github.com/atqamz/hand/issues/667)) ([3a96448](https://github.com/atqamz/hand/commit/3a96448d0108d8590e86f1de631bff1457831ff1))
* **store:** pin legacy cutover source descriptor ([#592](https://github.com/atqamz/hand/issues/592)) ([86ffe74](https://github.com/atqamz/hand/commit/86ffe7406ad7a3dcff5e62f6c52e122fe1d53c32)), closes [#348](https://github.com/atqamz/hand/issues/348)
* **store:** publish canonical v19 by atomic replace, never into an absent DB ([#674](https://github.com/atqamz/hand/issues/674)) ([106efdc](https://github.com/atqamz/hand/commit/106efdc6d62d0dcd76f4affc70b3eba5aabee6fd))
* **store:** refuse TaskHold blocked on a non-current Task ([#665](https://github.com/atqamz/hand/issues/665)) ([0f67888](https://github.com/atqamz/hand/commit/0f67888a27f3e7887fa2ca39b30ed64675d4c2a9))
* **store:** relock v19 replacement guards and activate exact schema ([b863fe0](https://github.com/atqamz/hand/commit/b863fe0b4452dc48e3d0c21367e96f05de6ab7ca))
* **store:** relock WorkerReport canonical tail ([#593](https://github.com/atqamz/hand/issues/593)) ([6555616](https://github.com/atqamz/hand/commit/65556169e04808460ba252a677754f19b190b8ab))
* use exact managed runtime generation ([#607](https://github.com/atqamz/hand/issues/607)) ([4ba4f3c](https://github.com/atqamz/hand/commit/4ba4f3cbe5bd1d3813c25a93db610509809dfb95))
