...
The isolated runtime remains pinned to its existing revision-4 embedded DDL and cutover authority identity. This revision-5 artifact is review input only. No dependent routing writer is activated. The candidate content commit `97d9f7c045a0060cac05a085221d91cb7fd661e8` pins the DDL and proof; this follow-up records the revised relock document blob. A later consumer switch still requires independent #344 review. Equal `user_version` cannot upgrade prior development databases.
...
relock Git blob: 47dbee82bfd6446f1d40861242831b93c673f974
```
