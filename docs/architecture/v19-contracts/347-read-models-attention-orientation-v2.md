...
contract_version: v19-read-model-v2
supersedes_revision: 899e7a9aa2e383d3b3f91689fe5a897c5bab59ec
supersedes_path: docs/architecture/v19-contracts/347-read-models-attention-orientation.md
supersedes_blob: 72a9905c84e376b8cd5a07ff2c0643b244e97d14
---

# Canonical read model, WorkerReport source proof, Task archive, Attention, and SupervisorOrientation — revision 2
...
The append witness is mechanism evidence only. It is never WorkerReport content/currentness, WorkerReport acknowledgement, WorkerInput acknowledgement, Decision/Answer authority, or progression authority. WorkerReport remains a Claim, and the existing canonical `worker_report` / `worker_report_acknowledgement` relations remain unchanged.

This contract chooses properties, not a provider/runtime mechanism. Exact source production must coordinate with #346's observation boundary and #579's launch-channel delivery work. No ordinary mutable path is described as qualified, and this revision introduces no generic reporting service or DDL change for the witness.
