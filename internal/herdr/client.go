...
// A server started inside a Claude Code session passes its own session identity down, and
// CLAUDE_CODE_CHILD_SESSION disables the pane's transcript - the only record of a worker (#109).
