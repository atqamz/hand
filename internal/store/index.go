...
// Nothing renders data/dashboard.md any more (#62), but a home initialized before its
// deletion keeps the last render on disk forever, and indexing that would answer a prose
// search out of a frozen snapshot of removed functionality.
